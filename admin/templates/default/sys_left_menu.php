...
<div class="container">
	...
	<div id="admin_left">
        <ul class="submenu">
            <!--<li><span>内容管理</span>
                <ul name="menu"><li class=""><a href="/content/view?model=news_content">新闻内容列表</a></li></ul>
            </li><li><span>分类管理</span>
                <ul name="menu"><li class=""><a href="/category_content/view?model=news">新闻中心</a></li></ul>
            </li>-->
            <li><span>免费话费活动管理</span>
                <ul name="menu"><li class="selected"><a href="/free_user/list?model=free_cost_user_model">客户列表</a></li></ul>
            </li>
        </ul>
	</div>
	<div id="admin_right">
